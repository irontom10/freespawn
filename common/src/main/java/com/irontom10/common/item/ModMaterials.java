...
public enum ModMaterials implements ArmorMaterial {
    ...
    PINK("pink",           50,  new int[]{ 3,  7,  5,  2},  40, SoundEvents.ARMOR_EQUIP_GENERIC, 0f, 0f, () -> Ingredient.of(ModItems.PINK.get())),
    TIGERSEYE("tigerseye",  80, new int[]{ 4,  8,  7,  4},  55, SoundEvents.ARMOR_EQUIP_GENERIC, 0f, 0f, () -> Ingredient.of(ModItems.TIGERSEYE.get())),
    PEACOCK("peacock",     40,  new int[]{ 2,  5,  4,  2},  30, SoundEvents.ARMOR_EQUIP_GENERIC, 0f, 0f, () -> Ingredient.of(ModItems.PEACOCK.get())),
